...
public class Splash extends AppCompatActivity {
    ...
    /*
     * sets the layout for the splash activity
     * also starts connection to database
     * opens welcome screen after splash screen
    */
    @Override
    ...
    /*
     * Function called to connect application to database
     */
